...
class Pelt():
    ...
    pelt_colours = [
        ...
        'CHOCOLATE', 'MOONSTONE', 'LEONID', 'SKYWARD', 'SIDEREAL', 'DEMIURGE', 'DIVINE', 'INTERSTELLAR',
        'HEAVENLY', 'DAWN', 'HOWLITE', 'SUNRISE', 'ASTRAL', 'PRISMATIC', 'CELESTIAL', 'PULSAR', 'STRATOSPHERE', 
        'LABRADORITE', 'METEORITE', 'SUNSET'
    ]
    pelt_c_no_white = [
    ...
    ginger_colours = ['CREAM', 'PALEGINGER', 'GOLDEN', 'GINGER', 'DARKGINGER', 'SIENNA', 'SUNRISE', 'ASTRAL',
                      'DAWN']
    black_colours = ['GREY', 'DARKGREY', 'GHOST', 'BLACK', 'SIDEREAL', 'DEMIURGE', 'INTERSTELLAR', 'PRISMATIC']
    white_colours = ['WHITE', 'PALEGREY', 'SILVER', 'MOONSTONE', 'STRATOSHPERE', 'CELESTIAL', 'PULSAR']
    brown_colours = ['LIGHTBROWN', 'LILAC', 'BROWN', 'GOLDEN-BROWN', 'DARKBROWN', 'CHOCOLATE', 'HOWLITE', 'DIVINE',
                     'METEORITE', 'SKYWARD', 'HEAVENLY', 'LABRADORITE', 'LEONID']
